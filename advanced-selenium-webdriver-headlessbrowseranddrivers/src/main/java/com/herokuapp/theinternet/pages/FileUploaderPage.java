...
public class FileUploaderPage extends BasePageObject {
	...
	public void selectFile(String fileName) {
		...
		//("user.dir")- returns path of the project
		//If we give path manually if other person is using it then they has to change the path so in order to avoid it we can use ("user.dir")
